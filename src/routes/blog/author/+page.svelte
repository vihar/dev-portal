	...
	<div class="mx-auto max-w-7xl py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-24">
		<div class="space-y-8 sm:space-y-12">
			<div class="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
				<h2 class="text-3xl font-bold tracking-tight sm:text-4xl">Meet our Blog contributors</h2>
			...
			>
				{#each uniqueAuthors as author}
					<a href="/blog/author/{author.title}">
						<div class="space-y-4">
							<img
							...
							<div class="space-y-2">
								<div class="text-xs font-medium lg:text-sm">
									<h3>{author.title} ({author.count})</h3>
									<p class="text-indigo-600">Dev Rel</p>
								</div>
							</div>
						</div>
					</a>
